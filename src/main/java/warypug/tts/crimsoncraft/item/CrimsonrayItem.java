...
public class CrimsonrayItem extends CrimsonCraftElements.ModElement {
	@ObjectHolder("crimsoncraft:crimsonray")
	public static final Item block = null;
	@ObjectHolder("crimsoncraft:entitybulletcrimsonray")
	public static final EntityType arrow = null;
	public CrimsonrayItem(CrimsonCraftElements instance) {
		super(instance, 4);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletcrimsonray").setRegistryName("entitybulletcrimsonray"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(CrimsonCraftItemGroup.tab).maxDamage(1000));
			setRegistryName("crimsonray");
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
					...
					if (stack != null && stack.getItem() == new ItemStack(CrimsonraypelletsItem.block, (int) (1)).getItem()) {
						slotID = i;
						break;
					}
				}
				if (entity.abilities.isCreativeMode || EnchantmentHelper.getEnchantmentLevel(Enchantments.INFINITY, itemstack) > 0 || slotID != -1) {
					...
					if (entity.abilities.isCreativeMode) {
						...
						if (new ItemStack(CrimsonraypelletsItem.block, (int) (1)).isDamageable()) {
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(CrimsonraypelletsItem.block, (int) (1));
		}
