...
public class UltracrimgemItem extends CrimsonCraftElements.ModElement {
	@ObjectHolder("crimsoncraft:ultracrimgem")
	public static final Item block = null;
	public UltracrimgemItem(CrimsonCraftElements instance) {
		super(instance, 15);
	}
