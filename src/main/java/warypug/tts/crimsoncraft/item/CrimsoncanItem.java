...
public class CrimsoncanItem extends CrimsonCraftElements.ModElement {
	@ObjectHolder("crimsoncraft:crimsoncan")
	public static final Item block = null;
	public CrimsoncanItem(CrimsonCraftElements instance) {
		super(instance, 11);
	}
